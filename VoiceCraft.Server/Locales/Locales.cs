...
public static class Locales
{
    ...
    public static string ServerProperties_Generating_Generating =>
        Localizer.Get("ServerProperties.Generating.Generating");
    ...
    public static string ServerProperties_Exceptions_ParseJson =>
        Localizer.Get("ServerProperties.Exceptions.ParseJson");
    ...
    public static string Commands_List_Options_ClientsOnly_Name =>
        Localizer.Get("Commands.List.Options.ClientsOnly.Name");

    public static string Commands_List_Options_ClientsOnly_Description =>
    ...
    public static string Commands_List_Options_Limit_Description =>
    ...
    public static string Commands_SetTitle_Arguments_Id_Description =>
        Localizer.Get("Commands.SetTitle.Arguments.Id.Description");

    public static string Commands_SetTitle_Arguments_Value_Name =>
        Localizer.Get("Commands.SetTitle.Arguments.Value.Name");

    public static string Commands_SetTitle_Arguments_Value_Description =>
    ...
    public static string Commands_SetDescription_Arguments_Id_Name =>
        Localizer.Get("Commands.SetDescription.Arguments.Id.Name");

    public static string Commands_SetDescription_Arguments_Id_Description =>
        Localizer.Get("Commands.SetDescription.Arguments.Id.Description");

    public static string Commands_SetDescription_Arguments_Value_Name =>
        Localizer.Get("Commands.SetDescription.Arguments.Value.Name");

    public static string Commands_SetDescription_Arguments_Value_Description =>
    ...
    public static string Commands_SetName_Arguments_Id_Description =>
        Localizer.Get("Commands.SetName.Arguments.Id.Description");

    public static string Commands_SetName_Arguments_Value_Name =>
        Localizer.Get("Commands.SetName.Arguments.Value.Name");

    public static string Commands_SetName_Arguments_Value_Description =>
    ...
    public static string Commands_SetPosition_Arguments_Id_Name =>
        Localizer.Get("Commands.SetPosition.Arguments.Id.Name");

    public static string Commands_SetPosition_Arguments_Id_Description =>
        Localizer.Get("Commands.SetPosition.Arguments.Id.Description");

    public static string Commands_SetPosition_Arguments_X_Name =>
        Localizer.Get("Commands.SetPosition.Arguments.X.Name");

    public static string Commands_SetPosition_Arguments_X_Description =>
        Localizer.Get("Commands.SetPosition.Arguments.X.Description");

    public static string Commands_SetPosition_Arguments_Y_Name =>
        Localizer.Get("Commands.SetPosition.Arguments.Y.Name");

    public static string Commands_SetPosition_Arguments_Y_Description =>
        Localizer.Get("Commands.SetPosition.Arguments.Y.Description");

    public static string Commands_SetPosition_Arguments_Z_Name =>
        Localizer.Get("Commands.SetPosition.Arguments.Z.Name");

    public static string Commands_SetPosition_Arguments_Z_Description =>
    ...
    public static string Commands_SetWorldId_Arguments_Id_Name =>
        Localizer.Get("Commands.SetWorldId.Arguments.Id.Name");

    public static string Commands_SetWorldId_Arguments_Id_Description =>
        Localizer.Get("Commands.SetWorldId.Arguments.Id.Description");

    public static string Commands_SetWorldId_Arguments_Value_Name =>
